 ...
 * @author user
 */
public class MenuSiang1 extends javax.swing.JFrame {

    String pesan = "";
    String kal = "";
    
    /**
     * Creates new form MenuSiang1
     */
    public MenuSiang1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Menu Makan Siang Anda");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String proteinsi = Integer.toString(protein);
        Passingprotein1.setprotein1(proteinsi);
        Passingtotprotein.settotprotein(proteinsi);
        
        String karbosi = Integer.toString(karbo);
        Passingkarbo.setkarbo(karbosi);
        Passingtotkarbo.settotkarbo(karbosi);
        
        String lemaksi = Integer.toString(lemak);
        Passinglemak.setlemak(lemaksi);
        Passingtotlemak.settotlemak(lemaksi);
        
        String si = Integer.toString(jumlah);
        PassingSIANG.setSIANG(si);
        Passingkalori.setkalori(si);
        ...
        insertpilihansiangIntoDatabase();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void insertpilihansiangIntoDatabase() {
       try {
           ...
           // Prepare the SQL statement
            String sql = "INSERT INTO pilihansiang (makanan) VALUES (?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuSiang1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuSiang1().setVisible(true);
            }
        });
    }
