 ...
 * @author user
 */
public class Kebijakan1 extends javax.swing.JFrame {

    /**
     * Creates new form Kebijakan1
     */
    public Kebijakan1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kebijakan Privasi");
        ...
        jLabel2.setText("Selamat datang di platform Calman. Calman");

        jLabel3.setText("dengan serius bertanggung jawab berdasarkan");

        jLabel4.setText("peraturan perundang-undangan tentang privasi");

        jLabel5.setText("yang berlaku dan berkomitmen untuk");

        jLabel6.setText("menghormati hak dan masalah privasi semua");

        jLabel7.setText("Pengguna Platform Calman kami. Kami");

        jLabel8.setText("mengakui pentingnya data pribadi yang telah");

        jLabel9.setText("Anda percayakan kepada kami dan percaya");

        jLabel10.setText("bahwa merupakan tanggung jawab kami untuk");

        jLabel11.setText("mengelola, melindungi dan mengolah data pribadi");

        jLabel12.setText("Anda dengan baik. Privasi ini dirancang untuk");

        jLabel13.setText("membantu Anda memahami bagaimana kami");

        jLabel14.setText("mengumpulkan, menggunakan, mengungkapkan");

        jLabel15.setText("dan/atau mengolah data pribadi yang telah Anda");

        jLabel16.setText("percayakan kepada kami.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kebijakan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kebijakan1().setVisible(true);
            }
        });
    }
