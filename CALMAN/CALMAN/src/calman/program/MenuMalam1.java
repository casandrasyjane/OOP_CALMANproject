 ...
 * @author user
 */
public class MenuMalam1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pilih Menu Makan Malam Anda");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String proteinmal = Integer.toString(protein);
        Passingprotein2.setprotein2(proteinmal);
        Passingtotprotein.settotprotein(proteinmal);
        
        String karbomal = Integer.toString(karbo);
        Passingkarbo.setkarbo(karbomal);
        Passingtotkarbo.settotkarbo(karbomal);
        
        String lemakmal = Integer.toString(lemak);
        Passinglemak.setlemak(lemakmal);
        Passingtotlemak.settotlemak(lemakmal);
        
        String mal = Integer.toString(jumlah);
        PassingMalam.setMALAM(mal);
        Passingkalori.setkalori(mal);
        ...
        jLabel1.setText(retrievedMAL);
        
        // Insert untuk pilihan yang nantinya dimasukkan ke dalam database
        insertpilihanmalamIntoDatabase();
        
    }//GEN-LAST:event_jButton1ActionPerformed

    private void insertpilihanmalamIntoDatabase() {
       try {
           ...
           // Prepare the SQL statement
            String sql = "INSERT INTO pilihanmalam (makanan) VALUES (?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuMalam1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuMalam1().setVisible(true);
            }
        });
    }
